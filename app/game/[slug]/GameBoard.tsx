...
export default function GameBoard( 
    playerCoords: any, 
    whoseTurn: string,
    handleRoomMoveClick: (coords: [number, number]) => void,
    gameid: string,
) {  
    ...
    <>
        ...
        <div className='grid grid-cols-1 font-bold'>
            ...
            <div className="w-auto flex-shrink-0 border border-purple-800 p-5 shadow-2xl bg-slate-900 rounded-sm"> {/* 2 times wider than the left column */}

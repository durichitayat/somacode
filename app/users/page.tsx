                      ...
                      <tbody>
                          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                              ...
                              <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                  <img className="w-10 h-10 rounded-full" src="placeholder.png" alt="Jese image" />
                                  <div className="ps-3">
                                      <div className="text-base font-semibold">Neil Sims</div>
                                      <div className="font-normal text-gray-500">neil.sims@email.com</div>
                                  </div>  
                              </th>
                              ...
                              <td className="px-6 py-4">
                                  <a href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Block user</a>
                              </td>
                          </tr>
                          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                              <td className="w-4 p-4">
                              ...
                              <th scope="row" className="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                  ...
                                  <div className="ps-3">
                                      ...
                                      <div className="font-normal text-gray-500">bonnie@email.com</div>
                                  </div>
                              </th>
                              <td className="px-6 py-4">
                                  User
                          ...
                          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                              ...
                              <th scope="row" className="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                  ...
                                  <div className="ps-3">
                                      ...
                                      <div className="font-normal text-gray-500">jese@email.com</div>
                                  </div>
                              </th>
                              <td className="px-6 py-4">
                                  User
                              ...
                              <td className="px-6 py-4">
                                  <a href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Unblock user</a>
                              </td>
                          </tr>
                          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                              <td className="w-4 p-4">
                              ...
                              <th scope="row" className="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                  ...
                                  <div className="ps-3">
                                      ...
                                      <div className="font-normal text-gray-500">thomes@email.com</div>
                                  </div>
                              </th>
                              <td className="px-6 py-4">
                                  User, Admin
                          ...
                          <tr className="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                              ...
                              <th scope="row" className="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                  ...
                                  <div className="ps-3">
                                      ...
                                      <div className="font-normal text-gray-500">leslie@email.com</div>
                                  </div>
                              </th>
                              <td className="px-6 py-4">
                                  User
                              ...
                              <td className="px-6 py-4">
                                  <div className="flex items-center">
                                      <div className="h-2.5 w-2.5 rounded-full bg-yellow-500 me-2"></div> Offline
                                  </div>
                              </td>
                              <td className="px-6 py-4">
                                  <a href="#" className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Block user</a>
